...
<body class="subpage">
	...
	<section id="main" class="wrapper">
		<div class="inner" style="padding: 30px; border-radius:10px; background-color: rgba(255, 255, 255, 0.55)">
			<h1>의료시설 검색</h1>
			<p style="color:black">현재 위치에 가까운 병원이나 약국을 찾아볼 수 있습니다</p>
			<div class="map_wrap">
				<div id="map"
	...
	src="//dapi.kakao.com/v2/maps/sdk.js?appkey=a66588c62df5f7fe1acd6e4e1c580174&libraries=services"></script>
<script>
